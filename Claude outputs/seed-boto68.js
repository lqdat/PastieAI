 ...
 *   node seed-boto68.js --agent <email> --cong-vat # cộng 8% VAT vào giá in
 ...
 *      · mặc định  : ghi đúng số in trên menu. Hoá đơn hiện đúng số đó, nghĩa là
 *                    quán chịu phần 8% — khách trả 175.000 cho món 175.000.
 *      · --cong-vat: nhân 1,08 rồi làm tròn đến 1.000đ. Khách trả 189.000 cho
 *                    món in 175.000, và đó mới là "chưa gồm VAT" đúng nghĩa.
...
async function main() {
  ...
  console.log(CONG_VAT
    ? 'Giá      : giá in trên menu + 8% VAT, làm tròn lên 1.000đ (--cong-vat)'
    : 'Giá      : ĐÚNG số in trên menu (menu ghi "chưa bao gồm 8% VAT")');
