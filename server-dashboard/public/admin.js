...
const TRANSLATIONS = {
    vi: {
        ...
        invoiceStatusPending: "Chờ xác nhận",
        invoiceStatusAwaiting: "Chờ thanh toán",
        invoiceStatusPaid: "Đã thanh toán",
        invoiceStatusRejected: "Đã từ chối",
        invoiceStatusSuperseded: "Đã thay bằng đơn mới",
        invoiceOpenPdf: "Mở PDF",
        invoiceChosen: "Đã chọn",
        payMethodCash: "Tiền mặt",
        payMethodBankQr: "Chuyển khoản QR",
        payMethodCard: "Thẻ",
        payMethodRoomCharge: "Cộng vào tiền phòng",
        payMethodPayLater: "Thanh toán sau",
    ...
    en: {
        ...
        chatLoadFailed: "Could not load messages. Check your connection and try again.",
        chatLoadRetry: "Try again",
        ...
        invoiceStatusPending: "Pending confirmation",
        invoiceStatusAwaiting: "Awaiting payment",
        invoiceStatusPaid: "Paid",
        invoiceStatusRejected: "Rejected",
        invoiceStatusSuperseded: "Replaced by new order",
        invoiceOpenPdf: "Open PDF",
        invoiceChosen: "Selected",
        payMethodCash: "Cash",
        payMethodBankQr: "Bank transfer (QR)",
        payMethodCard: "Card",
        payMethodRoomCharge: "Room charge",
        payMethodPayLater: "Pay later",
    ...
    ru: {
        ...
        invoiceSentToCustomer: "Счёт отправлен клиенту",
        invoiceStatusPending: "Ожидает подтверждения",
        invoiceStatusAwaiting: "Ожидает оплаты",
        invoiceStatusPaid: "Оплачено",
        invoiceStatusRejected: "Отклонено",
        invoiceStatusSuperseded: "Заменено новым заказом",
        invoiceOpenPdf: "Открыть PDF",
        invoiceChosen: "Выбрано",
        payMethodCash: "Наличные",
        payMethodBankQr: "Перевод по QR",
        payMethodCard: "Карта",
        payMethodRoomCharge: "На счёт номера",
        payMethodPayLater: "Оплата позже",
    ...
    zh: {
        ...
        chatLoadFailed: "无法加载消息。请检查网络后重试。",
        chatLoadRetry: "重试",
        ...
        msgStatusSent: "已发送",
        invoiceSentToCustomer: "发票已发送给客户",
        invoiceStatusPending: "待确认",
        invoiceStatusAwaiting: "待付款",
        invoiceStatusPaid: "已付款",
        invoiceStatusRejected: "已拒绝",
        invoiceStatusSuperseded: "已更换为新订单",
        invoiceOpenPdf: "打开 PDF",
        invoiceChosen: "已选择",
        payMethodCash: "现金",
        payMethodBankQr: "扫码转账",
        payMethodCard: "刷卡",
        payMethodRoomCharge: "记入房账",
        payMethodPayLater: "稍后付款",
    ...
    ko: {
        ...
        chatLoadFailed: "메시지를 불러오지 못했습니다. 연결을 확인한 뒤 다시 시도하세요.",
        chatLoadRetry: "다시 시도",
        ...
        msgStatusSent: "보냄",
        invoiceSentToCustomer: "고객에게 영수증 발송됨",
        invoiceStatusPending: "확인 대기 중",
        invoiceStatusAwaiting: "결제 대기 중",
        invoiceStatusPaid: "결제 완료",
        invoiceStatusRejected: "거절됨",
        invoiceStatusSuperseded: "새 주문으로 대체됨",
        invoiceOpenPdf: "PDF 열기",
        invoiceChosen: "선택됨",
        payMethodCash: "현금",
        payMethodBankQr: "QR 계좌이체",
        payMethodCard: "카드",
        payMethodRoomCharge: "룸 차지",
        payMethodPayLater: "나중에 결제",
...
function badgeImgUrl(_khung, ma, lang) {
    ...
    return `${goc}/hoa-${ma}-${lang || BADGE_PREVIEW_LANG}.png?v=v8`;
}
